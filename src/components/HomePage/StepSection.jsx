    ...
    const stepsData = [
      {
        ...
        tag: "Donations",
        title:
          "Let your supporters show their appreciation for your good work.",
        description:
          "Gift A Coffee simplifies and adds a fun twist to supporting creators, athletes, musicians and more. With just a few taps, your fans can make a payment to buy you a coffee and leave a message, all without needing to create an account!",
        reversed: false,
      },
      {
        id: 2,
